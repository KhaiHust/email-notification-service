module github.com/KhaiHust/email-notification-service/adapter

go 1.23.0

toolchain go1.23.2

replace github.com/KhaiHust/email-notification-service/core => ../core
...
require (
	...
	github.com/newrelic/go-agent/v3/integrations/nrredis-v9 v1.1.0
