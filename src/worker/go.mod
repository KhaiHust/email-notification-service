module github.com/KhaiHust/email-notification-service/worker
...
replace (
	github.com/KhaiHust/email-notification-service/adapter => ../adapter
	github.com/KhaiHust/email-notification-service/core => ../core
)
...
require (
	...
	github.com/golibs-starter/golib-cron v1.0.1 // indirect
