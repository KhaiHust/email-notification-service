...
import (
	"context"
	coreImpl "github.com/KhaiHust/email-notification-service/core/msg/impl"
	"github.com/KhaiHust/email-notification-service/core/msg/properties"
	...
	propertiesGolibMsg "github.com/golibs-starter/golib-message-bus/kafka/properties"
...
func KafkaAdminOpt() fx.Option {
	return fx.Options(
		...
		fx.Provide(coreImpl.NewSaramaAdmin),
...
func KafkaProducerOpt() fx.Option {
	return fx.Options(
		fx.Provide(fx.Annotated{
			...
			Target: coreImpl.NewSaramaProducerClient,
		}),
		...
		golib.ProvideProps(propertiesGolibMsg.NewEventProducer),
...
func NewSaramaConsumers(in KafkaConsumersIn) (core.Consumer, error) {
	return coreImpl.NewSaramaConsumers(in.GlobalProps, in.ConsumerProps, in.SaramaMapper, in.Handlers)
}
